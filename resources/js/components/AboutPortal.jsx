            ...
            <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-16 items-center">
                <div className="flex-1">
                    <motion.div
                        ...
                        className="space-y-6"
                    >
                        <span className="text-[#d4a574] font-black text-xs uppercase tracking-[0.3em]">Civil Registry</span>
                        <h2 className="text-5xl md:text-6xl font-black text-white leading-tight">Preserving Naic's Local Heritage</h2>
                        <p className="text-slate-400 text-lg leading-relaxed max-w-2xl text-justify">
                            The Municipal Civil Registrar's Office of Naic is dedicated to the proper registration, archival, and administration of the fundamental civic events of our citizens. We meticulously record the milestones of our local population—safeguarding Births, Marriages, and Deaths to establish permanent, secure, and legally binding civil identification.
                        </p>
