            ...
            >
                ...
                <div className="flex-1 flex overflow-hidden">
                    {file.file_path && viewMode !== 'compare' && (
                        <div className="w-[35%] border-r border-slate-100 bg-slate-50 p-4 flex flex-col shrink-0">
                            ...
                            <div className="flex-1 rounded-xl bg-white border border-slate-200 overflow-hidden relative flex items-center justify-center">
                                {isDocLoading && (
                                    <div className="absolute inset-0 z-10 flex flex-col items-center justify-center bg-slate-50/90 backdrop-blur-xs">
                                        <div className="w-8 h-8 border-3 border-indigo-200 border-t-indigo-600 rounded-full animate-spin"></div>
                                        <span className="text-[11px] font-extrabold text-slate-600 mt-3">Loading Reference Scan...</span>
                                    </div>
                                )}
                                {isPdf ? (
                                    <iframe
