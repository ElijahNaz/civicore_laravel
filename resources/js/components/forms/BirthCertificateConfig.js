...
export const BirthTemplateOverlayFields = [
    ...
    { key: 'sex', label: 'Sex', x: 0.20, y: 0.21, w: 0.10, h: 0.015 },
    { key: 'date_of_birth', label: 'Date of Birth', x: 0.42, y: 0.21, w: 0.45, h: 0.015 },

    { key: 'place_of_birth_hospital', label: 'Hospital/Clinic/Institution', x: 0.22, y: 0.25, w: 0.25, h: 0.015 },
    { key: 'place_of_birth_city', label: 'City/Municipality', x: 0.50, y: 0.25, w: 0.20, h: 0.015 },
    { key: 'place_of_birth_province', label: 'Province', x: 0.73, y: 0.25, w: 0.20, h: 0.015 },

    { key: 'type_of_birth', label: 'Type of Birth', x: 0.20, y: 0.29, w: 0.12, h: 0.015 },
    { key: 'multiple_birth_order', label: 'If Multiple, Child Was', x: 0.40, y: 0.29, w: 0.12, h: 0.015 },
    { key: 'birth_order', label: 'Birth Order', x: 0.58, y: 0.29, w: 0.12, h: 0.015 },
    { key: 'weight_at_birth', label: 'Weight at Birth', x: 0.75, y: 0.29, w: 0.18, h: 0.015 },

    // MOTHER
    { key: 'mother_first_name', label: 'Mother First Name', x: 0.18, y: 0.35, w: 0.25, h: 0.015 },
    { key: 'mother_middle_name', label: 'Mother Middle Name', x: 0.45, y: 0.35, w: 0.25, h: 0.015 },
    { key: 'mother_last_name', label: 'Mother Last Name', x: 0.72, y: 0.35, w: 0.25, h: 0.015 },

    { key: 'mother_citizenship', label: 'Mother Citizenship', x: 0.18, y: 0.39, w: 0.30, h: 0.015 },
    { key: 'mother_religion', label: 'Mother Religion', x: 0.52, y: 0.39, w: 0.35, h: 0.015 },
